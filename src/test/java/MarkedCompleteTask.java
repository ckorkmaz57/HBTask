...
public class MarkedCompleteTask {
    ...
    @Test
    public void MarkedCompleteTest() {
        ...
        String title = "task işaretleme çalışması";
        String description="task işaretleme çalışması detay";
        ...
        //Taskın işaretlemesi yapılır.
        MobileElement check_box = (MobileElement) driver.findElementById("com.example.android.architecture.blueprints.todomvp.mock:id/complete");
        check_box.click();
